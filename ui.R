  ...
  dashboardSidebar(
    sidebarMenu(
      ...
      menuItem("My Dataset", icon = icon("user"),
               ...
               menuSubItem("Calories Burned Over Time", tabName = "calorie_chart", icon = icon("fire"))
      ),
  ...
  dashboardBody(
    tabItems(
      tabItem(
        ...
        fluidRow(
          valueBoxOutput("total_workouts"),
          valueBoxOutput("avg_calories"),
          valueBoxOutput("workouts_per_week")
        ),
        ...
        h2("Turn Sweat Into Insights"),
        p("Your workouts, calories, and data all in one place. Gains not included, but highly recommended.")
